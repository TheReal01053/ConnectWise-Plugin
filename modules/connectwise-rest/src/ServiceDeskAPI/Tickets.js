 ...
 * @author kgrube
 * 
 * Modified by: Micheal Thompson on 16/05/2019 : <Micheal.thompson@claratti.com>
 */
 ...
 * @returns {Promise<Ticket[]>}
 */
Tickets.prototype.getTicketNotesById = function (id) {
  return this.api(`/service/tickets/${id}/notes`, 'GET', {
    json: true
  });
};
